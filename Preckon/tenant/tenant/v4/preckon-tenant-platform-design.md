...
**Version:** 1.2 (generic framework). Domain-neutral; each domain pack is a separate implementation deck. §6.4 adds the persona roster; §1.6 adds a generic project-lifecycle state field (the machine itself is pack data).
